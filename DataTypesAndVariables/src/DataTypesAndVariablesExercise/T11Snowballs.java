...
public class T11Snowballs {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < countSnowballs; i++) {
            ...
            double workSum =  Math.pow((snowballSnow/snowballTime),snowballQuality);
            if (workSum>sum){
                sum = workSum;
        ...
        System.out.printf("%d : %d = %.0f (%d)",snowballSnowHighest,snowballTimeHighest,sum,snowballQualityHighest);
    }
}
